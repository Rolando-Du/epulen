...
const Hero = () => {
  const valuePoints = [
    {
      title: "Protección",
      text: "Elementos de seguridad para tareas exigentes.",
    },
    {
      title: "Industria",
      text: "Soluciones para distintos entornos de trabajo.",
    },
    {
      title: "Asesoramiento",
      text: "Acompañamiento para elegir el equipo adecuado.",
    },
  ];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
          ...
          <div className="relative w-full">
            <div className="relative rounded-3xl border border-[#D7DDD4] bg-[#E8EBE5] p-2 shadow-[0_24px_70px_rgba(36,49,40,0.10)] sm:rounded-4xl sm:p-4">
              {/* MOBILE USES 4/3 TO GIVE THE VIDEO MORE HEIGHT */}
