      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            ...
            <div className="inline-flex items-center gap-3 w-fit px-4 py-2 rounded-full border border-[#24A35A]/30 bg-[#24A35A]/10 mb-8">
              ...
              <span className="text-[#24A35A] text-[10px] font-black tracking-[0.2em] uppercase">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6">
              <a
                href="#catalogo"
                className="bg-[#24A35A] hover:bg-[#E67E22] text-white px-8 md:px-10 py-4 md:py-5 rounded-2xl font-black transition-all duration-500 shadow-xl shadow-[#24A35A]/20 uppercase tracking-widest text-xs transform hover:-translate-y-1 text-center"
              >
                Explorar Catálogo
              </a>
              <div className="flex items-center gap-4 px-6 py-4 rounded-2xl border border-slate-800 bg-slate-900/30 backdrop-blur-sm">
                <div className="text-[#E67E22] font-black text-xs md:text-sm tracking-tighter uppercase">
                  Normativa 2025
                </div>
          ...
          <div className="lg:col-span-5 relative hidden lg:block">
            <div className="relative z-10 rounded-4xl overflow-hidden border border-slate-800 group transition-all duration-500 hover:border-[#24A35A]/50 shadow-2xl">
              ...
              {/* Badge Flotante */}
              <div className="absolute bottom-6 left-6 right-6 bg-[#020617]/90 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center justify-between">
                <div>
                  <div className="text-[#24A35A] font-black text-lg tracking-tighter italic">
                    MAX-GEAR
                  </div>
                  <div className="text-slate-400 text-[8px] uppercase tracking-widest font-bold">
                    Protección Profesional
                  </div>
                </div>
                <div className="h-8 w-8 rounded-full border border-[#24A35A]/30 flex items-center justify-center">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#24A35A] animate-pulse"></div>
                </div>
              </div>
            </div>

            {/* Decoración geométrica reducida para evitar colisiones */}
            <div className="absolute -bottom-4 -left-4 w-24 h-24 border-l-2 border-b-2 border-[#24A35A]/20 rounded-bl-4xl -z-10"></div>
